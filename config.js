...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_9dda84fc2524a43b9a94c625783f8df2a').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || 2348144317152,2348155763709,2348054984935',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,WALLY JAY TECH',
  ALWAYS_ONLINE: process.env.ALWAYS_ONLINE 'true',
  LOG_MSG: process.env.LOG_MSG || 'false',
  RMBG_KEY: process.env.RMBG_KEY || 'dyrbNSNtMf1CE84he61DR7Wx',
  ...
  MENTION: process.env.MENTION || 'user mentioned is busy',
